...
// import { candidate } from '../../actions/trips'
        ...
        <form onSubmit={this.handleOnSubmit}>
          {register.map(input => (
            <div key={input.name}>
              ...
              <label>Escolha o pais: </label>
              <select onChange={this.handleInputChange} name="country" id="paises">
             ...
             <ContainerViagens>
                <label>Escolha uma Viagem: </label>
                  <select
                    ...
                    <option 
                    value={trip.id}>{trip.name} - {trip.planet}
                    </option>))}
                    
                  </select>
              </ContainerViagens>
          <div>
              <Botao onClick={this.handleOnSubmit} type="submit">Enviar</Botao>
          </div>
        </form>
      </Container>
    );
